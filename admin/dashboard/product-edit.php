				...
				<div class="pd-20 card-box mb-30">
					...
					<form>
						<div class="form-group">
							...
							<input pattern="[a-zA-Z]*" aria-describedby="textHelp" class="form-control" type="text" placeholder="T-Shirt">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input class="form-control" type="text" placeholder="Clothing">
						</div>
						<div class="form-group">
							<label>MRP</label>
							<input class="form-control" value="2224" type="number">
						</div>
						<div class="form-group">
							<label>Price</label>
