		...
		<div class="pd-ltr-20">
				...
				<div class="row align-items-center">
					...
					<div class="col-md-8">
						<h4 class="font-20 weight-500 mb-10 text-capitalize">
							Welcome back <div class="weight-600 font-30 text-blue">Hardick pande!</div>
						</h4>
						<p class="font-18 max-width-600">There are Manditory Actions to be</p>
					</div>
				</div>
			</div>
					...
					<div class="card-box height-100-p widget-style1">
						<div class="d-flex flex-wrap align-items-center">
							...
							<div class="widget-data">
								...
								<div class="weight-600 font-14">Daily Book <br>Sold</div>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="card-box height-100-p widget-style1">
						<div class="d-flex flex-wrap align-items-center">
							...
							<div class="widget-data">
								...
								<div class="weight-600 font-14">Daily Book<br> Borrowed</div>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="card-box height-100-p widget-style1">
						<div class="d-flex flex-wrap align-items-center">
							...
							<div class="widget-data">
								...
								<div class="weight-600 font-14">Profit</div>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-xl-4 mb-30">
					<div class="card-box height-100-p pd-20">
						<h2 class="h4 mb-20">You are Up-To-Date</h2>
						<div id="chart6"></div>
					</div>
				</div>
			</div>
